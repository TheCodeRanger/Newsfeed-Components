...
*/
const articles = document.querySelector(".articles"); //based off the guided project, not sure if/why I need it
...
articleElements.forEach((articleElement) => { //data hydration!!
